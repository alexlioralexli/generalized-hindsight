...
def experiment(variant, cfg):
    ...
    if isinstance(expl_env.observation_space, Discrete) or isinstance(expl_env.observation_space, MultiBinary):
        ...
        cfg.agent.params.obs_dim = expl_env.observation_space.n
    else:
        obs_dim = expl_env.observation_space.low.size
        cfg.agent.params.obs_dim = expl_env.observation_space.low.size
    action_dim = expl_env.action_space.low.size
    latent_dim = variant['replay_buffer_kwargs']['latent_dim']
    cfg.agent.params.action_dim = expl_env.action_space.low.size
    cfg.agent.params.action_range = [
